...
/*
	...
	var res3 = jsonpath(ast, "$..[?(@.type==='AssignmentExpression' && @.right!== null && @.right.type === 'FunctionExpression' && @.right.callee !== null  && @.right.callee.name!== null && @.right.callee.name === 'require')]", {resultType:"VALUE"});
	var res4 = jsonpath(ast, "$..[?(@.type==='AssignmentExpression' && @.right!== null && @.right.type === 'FunctionExpression' && @.right.callee !== null  && @.right.callee.name!== null && @.right.callee.name === 'require')]", {resultType:"PATH"});	

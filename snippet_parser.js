...
/*
	...
	var res3 = jsonpath(ast, "$..[?(@.right!=='undefined' && @.right.callee !== 'undefined' && @.right.callee.name === 'require')]", {resultType:"VALUE"});
	var res4 = jsonpath(ast, "$..[?(@.right!=='undefined' && @.right.callee !== 'undefined' && @.right.callee.name === 'require')]", {resultType:"PATH"});	
